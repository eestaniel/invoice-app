  ...
  return (
    ...
    ${theme.background}`}>
      ...
      >
        ...
        {/* nav content */}
        <div
          className="nav-content flex flex-row xl:flex-col h-full xl:h-auto grow justify-end pr-8 xl:pr-0 xl:mb-8 items-center gap gap-6">
          <>
            {/* dark mode icon */}
            {isNightMode ?
            ...
            <svg className="svg-icon w-[1rem] h-[1rem] xl:w-[1.5rem] xl:h-[1.5rem] group hover:cursor-pointer hover:fill-5-secondary"
              ...
              <path
                ...
                fill="" className="fill-6-muted group-hover:fill-white"/>
            </svg>
