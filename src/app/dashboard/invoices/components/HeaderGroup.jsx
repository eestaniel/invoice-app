...
export default function HeaderGroup() {
  ...
  return (
    <div className="content px-[22rem] pt-[4.875rem] w-screen">
      <div className="invoice-header-container flex flex-row items-center justify-between w-full gap-[2.5rem]">
        ...
        <div className="group2">
          <Button className="bg-1-primary text-white rounded-[1.5rem] h-[3rem] w-[9.375rem] p-0 gap-[1rem]
          hover:bg-2-highlight"
                  onClick={() => {
                    addInvoice('asd')
                  }}
          >
