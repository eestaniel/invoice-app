    ...
    <div className="bill-from-group flex flex-col">
      ...
      <div className="group flex flex-col w-full gap-[0.625rem]">
        ...
        <Input
          ...
          `}
        />
        {errors.bill_from?.street_address && <span className="text-red-600 mb-4">{errors.bill_from?.street_address?.message}</span>}
      </div>
      ...
      <div className="bill-from-group__group2 flex flex-row justify-between w-full gap-[1.5rem]">
        ...
        <div className="group flex flex-col w-full gap-[0.625rem]">
          ...
          `}
          />
          {errors.bill_from?.country && <span className="text-red-600 mb-4">{errors.bill_from?.country?.message}</span>}
        </div>
      </div>
    </div>
  );
