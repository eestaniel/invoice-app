...
export default function InvoiceDetails() {
  ...
  return (
    <div className="bill-to-group flex flex-row mb-[1.5rem] mt-[2rem] w-full h-fit flex-wrap gap-2 justify-between">
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                ...
                {formValues.invoice_date && format(new Date(formValues.invoice_date), 'd MMM yyyy')}
      ...
      {/* payment Terms*/}
      <div
        className="group flex flex-col gap-[0.625rem] relative flex-wrap lg:flex-nowrap grow max-w-[100%] md:max-w-[48%]">
